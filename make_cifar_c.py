...
def frost(x, severity=1):
    ...
    filename = ['cifar10c/frost/frost1.png', 'cifar10c/frost/frost2.png', 'cifar10c/frost/frost3.png',
                'cifar10c/frost/frost4.jpg', 'cifar10c/frost/frost5.jpg', 'cifar10c/frost/frost6.jpg'][idx]
...
for method_name in d.keys():
    ...
    np.save('cifar10-c-datasets/' + d[method_name].__name__ + '.npy',
            np.array(cifar_c).astype(np.uint8))

    np.save('cifar10-c-datasets/labels.npy',
